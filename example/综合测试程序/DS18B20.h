...
const uchar code SegCode[10]={0xC0,0xF9,0xA4,0xB0,0x99,0x92,0x82,0xF8,0x80,0x90};//共阳极段码 0~9
const uchar code BitCode[]={0x08,0x04,0x02,0x01};						//位码:P0 口“1”有效
uchar DispBuf[4]={1,1,1,1};						//显示缓冲区
bit zf;
int Temp;
